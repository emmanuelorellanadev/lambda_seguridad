...
export const Table = ({ columns, rows, editData, deleteData, url, setOnLoad}) => {
              ...
              if(editData && deleteData){
                  return (
                    <tr key={values[0]}>
                      ...
                      <th><button className='btn btn-outline-danger' onClick={ () => deleteData(url, values[0], values[1], setOnLoad) }><i className='bi bi-trash3-fill'></i></button></th>
                    </tr>
                  )
              }else if(editData){
                return (
