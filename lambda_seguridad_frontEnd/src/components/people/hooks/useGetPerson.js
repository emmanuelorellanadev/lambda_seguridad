...
export const useGetPerson = async(urlPerson, {setPeople, setNames, setSurNames, setCui, setNit, setPhone, setAddress, setPersonTypeId, setBranchId, setNextPage, setPrevPage}) => {
